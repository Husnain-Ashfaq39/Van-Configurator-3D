...
const BunkInstance = ({ id, initialPosition, view, onCopy, onRemove }) => {
  const {
    clonedScene,
    position,
    rotationY,
    ...
    handleDoubleClick,
    handleCloseMenu,
  } = useInstanceLogic('/Bunk.glb', initialPosition, view); // Use the correct GLB file path
